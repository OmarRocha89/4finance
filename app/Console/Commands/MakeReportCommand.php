...
class MakeReportCommand extends Command
{
     ...
     * @var string
     */
    protected $signature = 'make:Fintech';
    ...
    public function handle()
    {
     ...
     /* $day = Carbon::now()->format('dmY');
      $fileName = "EstadoDeCuenta__4FINANCE_CRE00773_".$day."_ELITE-DIC";
      echo $fileName;
      exit();*/

      $fileName ="EstadoDeCuenta__4 FINANCE_CRE00773_06052023";
  
    
      $fileIsMissing = Storage::disk('sftp')->missing('archivos/Credito_Files/Layout_Edo_Cta/Fintech/'.$fileName.'.txt');
      ...
      if ($fileIsMissing ) {
        ...
        $contents = Storage::disk('sftp')->get('archivos/Credito_Files/Layout_Edo_Cta/Fintech/'.$fileName.'.txt');
       ...
       // $file = file(public_path("docs/EstadoDeCuenta__4 FINANCE_CRE00773_06042023_Elite.txt"));
        ...
        foreach($file as $key => $line) {
            ...
            switch (Str::substr($line,0,2)) {
                ...
                case '03':
                    ...
                    //EXTRA FINTECH 36.00 / 10


                    $TazaOrdAnual= round($tasaInteresOrdinariaAnual*10,5);

                    
                    ///////////////

                    $tazaMensualPorcentaje = $TazaOrdAnual/12;
                    //pasar la tasa a cifra
