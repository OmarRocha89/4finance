...
<div style="background:#fff;padding:30px;" >
 ...
 <b-col lg="6" class="my-1">
      ...
      <b-col lg="12" class="my-1">
        ...
        >
          ...
          >
            ...
            <b-form-checkbox class="filterCheck" value="subproducto"> Subproducto</b-form-checkbox>
            <b-form-checkbox class="filterCheck" value="fechaCorte"> fecha Corte</b-form-checkbox>
    ...
    <div class="col-xs-12 my-3">
            <a  class="btn btn-primary" :href="'/facturas'" > 
            Facturas
          </a> 
</div>
    ...
    >
      <template #cell(actions)="datos" >
          ...
          <a class="btn btn-info" :href="'/clientes'" > 
            Ver Cliente
          </a>
      </template>
      <!--<template >
    ...
    data() {
      return {
        ...
        fields: [
          ...
          { key: 'subproducto', sortable: true},
          { key: 'fechaCorte', sortable: true },
          { key: 'numeroRegistrosOperaciones', sortable: true },
