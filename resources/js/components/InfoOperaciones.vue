      ...
      <b-col lg="12" class="my-1">
        ...
        >
          ...
          >
            ...
            <b-form-checkbox class="filterCheck" value="rfcComercio"> RFC del Comercio</b-form-checkbox>
            <b-form-checkbox class="filterCheck" value="fechaOperacion"> Fecha del movimiento</b-form-checkbox>
            <b-form-checkbox class="filterCheck" value="pesos">Monto</b-form-checkbox>
            <b-form-checkbox class="filterCheck" value="idMovimiento">id de movimiento</b-form-checkbox>
            <b-form-checkbox class="filterCheck" value="claveMovimiento">clave de movimiento</b-form-checkbox>
          </b-form-checkbox-group>
        </b-form-group>
      </b-col>
...
<div class="col-xs-12 my-3">
    ...
    >
      <!--<template #cell(actions)="datos" >
            <a :href="`/datos-cortes/`+datos.item.NoCliente.trim()" > <b-icon icon="file-earmark" aria-hidden="true"></b-icon>
            Regresar
          </a> 
      </template>-->
    </b-table>
  ...
  export default {
      ...
      return {
        ...
        fields: [
         // { key: 'actions', label: 'Actions' },
          ...
          { key: 'fechaOperacion', sortable: true},
          { key: 'fechaAplicacion', sortable: true },
          { key: 'descripcion', sortable: true },
          { key: 'rfcComercio', sortable: true },
          { key: 'poblacion', sortable: true },
          { key: 'monedaExtranjera', sortable: true },
          { key: 'montoDivisaExtranjera', sortable: true },
          { key: 'pesos', sortable: true, label:'Monto' },
          { key: 'claveMovimiento', sortable: true },
          { key: 'idMovimiento', sortable: true },
          { key:'comisiones', sortable:true},
    ...
    methods:{
             ...
             traerDatos(){
                ...
                axios.get('/info-operaciones'+'/'+this.id)
                    .then( res => {
                        this.datos = res.data;
