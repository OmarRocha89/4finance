        ...
        <tbody>
            ...
            <tr>
                ...
                <td style="padding:10px 20px 20px 20px; text-align: right;">
                    ...
                    <p style="padding:0px; color:#000; font-size:12px;">Tarjeta de Crédito Fintech</p>
                                                    ...
                                                    <table style="width:98%; padding:0px 3px;" class="row-blanca"
                                                        ...
                                                        <tbody>
                                                            <tr>
                                                                ...
                                                                <!--<td style="text-align:right;  padding:5px;">357.04%</td>-->
                                                                <td style="text-align:right;  padding:5px;">640.72%</td>
                                                            </tr>
                                                        </tbody>
                                                    </table>
                                                </td>
                                                    ...
                                                    <table style="width:98%; padding:0px 3px;" class="row-gris"
                                                        ...
                                                        <tbody>
                                                            <tr>
                                                               ...
                                                               <!--<td style="text-align:right; padding:5px;">162%</td>-->
                                                                <td style="text-align:right; padding:5px;">108%</td>
                                                            </tr>
                                                        </tbody>
                                                    </table>
                                                </td>
                                                    ...
                                                    <table style="width:98%; padding:0px 3px;" class="row-blanca"
                                                        ...
                                                        <tbody>
                                                            <tr>
                                                                <td style="text-align:left; padding:5px;">Tasa de
                                                                    Interés Mensual</td>
                                                                <!--<td style="text-align:right;  padding:5px;">13.5%</td>-->
                                                                 <td style="text-align:right;  padding:5px;">9%</td>
                                                            </tr>
                                                        </tbody>
                                                    </table>
                                                </td>
                                                    ...
                                                    <table style="width:98%; padding:0px 3px;" class="row-blanca"
                                                        ...
                                                        <tbody>
                                                            <tr>
                                                                ...
                                                                <td style="text-align:right; padding:5px;">$2,000MXN (Más IVA)</td>
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                               @switch($item['claveMovimiento'])
                                                   ...
                                                   @case('INTMOR')
                                                   @case('IVAINTMOR')
                                                    <td style="padding:5px; font-size:12px; text-align:center; width:80px;" colspan="1">${{ number_format($item['pesos'],2) }} </td>
    ...
    <table style="padding:10px; background: #fff; margin-top: 30px; margin-bottom: 30px; width:700px;" width="700"
        ...
        <tbody>
            ...
            <tr>
                ...
                <td style="padding:10px;font-size:10px;">{{$rfc}}</td>
